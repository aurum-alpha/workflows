...
| AU5 | Sessions end, and revocation does not wait for them to | live gates are available for the observable half: a session refusing service after its absolute cap, and logout ending the proxy session (proposed) | **review only** |
