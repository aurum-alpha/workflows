...
| `060` | AU | [`060-auth.md`](standards/060-auth.md) | Authentication: the identity tier, the verified access token, identity linkage, provisioning, sessions, deployment topologies, who masters which identity field | review, corpus written |
