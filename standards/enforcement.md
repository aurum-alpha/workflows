...
| IP4 | Instants are RFC 3339 UTC `Z` with exactly three fractional digits; calendar dates are `full-date`; MySQL profile `DATETIME(3)` | corpus validity + canonical cases (proposed, same job) | **review only** |
