...
| `060` | AU | [`060-auth.md`](standards/060-auth.md) | Authentication: the identity tier, the verified access token, identity linkage, provisioning, sessions, deployment topologies | review, corpus written |
